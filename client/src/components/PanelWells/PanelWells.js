...
// i used the entire template code to make this component.  
//starting at line 134 is the collapsible code that is the goal to use.
//
...
PanelWells.contextTypes = { setTitle: PropTypes.func.isRequired };
